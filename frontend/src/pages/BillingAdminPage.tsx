...
const sar = (minor: number) => `${toEnglishDigits((Number(minor || 0) / 100).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }))} ر.س`;
