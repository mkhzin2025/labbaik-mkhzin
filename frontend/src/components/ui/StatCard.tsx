...
const StatCard = React.forwardRef<HTMLDivElement, StatCardProps>(
  ({
    ...
    return (
      <Card variant="default" ref={ref} className={className} {...props}>
        <CardBody className="space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="text-neutral-400 text-xs font-semibold uppercase tracking-wider">{label}</h3>
            <p className="text-2xl font-black text-neutral-0 tabular-nums">
